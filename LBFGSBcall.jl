...
function LBFGSBcall(fun, ctrl, bound)
    ...
    normgrad = Vector{Float64}()            # norm of the gradient
    ...
    if task[1:5] == b"NEW_X"
        ...
        # niter ≥ 250 && (task[1:4] = b"STOP"; terminate_info="REACHED MAX NR. OF ITERATIONS")
